    ...
    <section id="proceso">
      <div className="wrap grid2">
        <div className="surface reveal">
          ...
          <p className="p" style={{marginTop:8}}>Sin lista de precios: estimamos por complejidad e impacto.</p>
        </div>
        <div className="surface reveal" aria-label="Clientes y partners">
          ...
          <div style={{display:"flex",gap:28,flexWrap:"wrap",alignItems:"center",opacity:.9,marginTop:6}}>
