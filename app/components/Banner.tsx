...
export default function SeccionAutomatizacion() {
  ...
  const openWhatsApp = () => {
    ...
    const message = "Hola, vi su página web y me interesa conversar sobre cómo pueden evolucionar mi negocio.";
    ...
    <section id="automatizacion" className="nm-section relative overflow-hidden min-h-[35vh] flex items-center py-6">
      ...
      <div className="relative z-20 w-full max-w-lg mx-auto px-3">
        <div className="text-center">
          ...
          <div className="bg-black/45 backdrop-blur rounded-lg p-3 border border-white/5 max-w-sm mx-auto mb-3">
            <p className="text-sm text-white font-medium leading-tight">
              Transformá tu operación con tecnología que piensa y aprende.
            </p>
          </div>

          {/* BOTÓN WHATSAPP - Muy visible */}
          <div className="mt-3">
            <button 
              onClick={openWhatsApp}
              className="px-4 py-2 bg-green-600 hover:bg-green-700 text-white rounded-lg font-bold text-sm transition-all duration-300 shadow-lg hover:shadow-xl flex items-center justify-center mx-auto gap-2"
            >
